        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                ...
                <ul class="list-unstyled mt-3 mb-4">
                    <li><span style="color: red"><?php echo $data['gia'] ?>.000</span> <small class="text-muted" style="text-decoration: line-through"></small></li>
                </ul>
            </div>
            <div class="card-footer bg-transparent border-0 row justify-content-center">
                ...
                <a href="giohang.php" class="btn btn-info col-6 rounded-0">Đặt hàng</a>
            </div>
        </div>
        <?php } }?>
    </div>
